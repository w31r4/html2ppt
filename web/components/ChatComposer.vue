<template>
  <div>
    <div class="relative rounded-2xl border border-gray-200/70 dark:border-gray-700/70 bg-white/80 dark:bg-[#111317]/80 shadow-[0_12px_30px_rgba(15,23,42,0.08)] backdrop-blur focus-within:ring-2 focus-within:ring-primary/30">
      <label for="chat-input" class="sr-only">Describe your presentation</label>
      <textarea
        id="chat-input"
      ...
      <div class="absolute bottom-3 right-3 flex items-center gap-2">
        <span class="hidden sm:inline text-[10px] text-gray-400" aria-hidden="true">Cmd/Ctrl + Enter</span>
        <button
    ...
    <p id="chat-hint" class="text-[11px] text-gray-400 mt-2 text-center">Tip: add audience, theme, and time limit.</p>
  </div>
</template>
